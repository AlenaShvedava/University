        ...
        if ((!(chooseDone.toUpperCase(Locale.ROOT).equals("YES")) && (!(chooseDone.toUpperCase(Locale.ROOT).equals("NO"))))) {
            ...
            switch (chooseDone.toUpperCase(Locale.ROOT)) {
                ...
                case "YES": {
                    ...
                    name.add(faculty.next());
                    applicant.setFirstLastName(name.get(0) + " " + name.get(1));
                    System.out.println("Enter your date of birth\n");
                    applicant.setDateOfBirth(faculty.next());
                    ...
                    applicants.add(new Applicant(applicant.getId(), applicant.getFirstLastName(), applicant.getDateOfBirth(), applicant.getFaculty(), applicant.getSpeciality(), applicant.getValues(), applicant.getSum()));
                    ...
                    Pass.give();
                    applicants.set(14, new Applicant(applicant.getId(), applicant.getFirstLastName(), applicant.getDateOfBirth(), applicant.getFaculty(), applicant.getSpeciality(), applicant.setValues(), applicant.getSum()));
                }
            }
        }
    }
